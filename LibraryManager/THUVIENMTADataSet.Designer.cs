...
namespace LibraryManager {
    ...
    public partial class THUVIENMTADataSet : global::System.Data.DataSet {
        ...
        public partial class NHANVIENDataTable : global::System.Data.TypedTableBase<NHANVIENRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public NHANVIENRow AddNHANVIENRow(string MaNhanVien, string TenNhanVien, string ChucVu, System.DateTime NgaySinh, string GioiTinh, string DiaChi, string Email, string SDT, string CMND, string TenDangNhap) {
...
namespace LibraryManager.THUVIENMTADataSetTableAdapters {
    ...
    public partial class NHANVIENTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[NHANVIEN] WHERE (([id] = @Original_id) AND ([MaNhanVien] = @Original_MaNhanVien) AND ([TenNhanVien] = @Original_TenNhanVien) AND ([ChucVu] = @Original_ChucVu) AND ([NgaySinh] = @Original_NgaySinh) AND ([GioiTinh] = @Original_GioiTinh) AND ([DiaChi] = @Original_DiaChi) AND ([Email] = @Original_Email) AND ([SDT] = @Original_SDT) AND ([CMND] = @Original_CMND) AND ([TenDangNhap] = @Original_TenDangNhap))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[NHANVIEN] ([MaNhanVien], [TenNhanVien], [ChucVu], [NgaySinh], [GioiTinh], [DiaChi], [Email], [SDT], [CMND], [TenDangNhap]) VALUES (@MaNhanVien, @TenNhanVien, @ChucVu, @NgaySinh, @GioiTinh, @DiaChi, @Email, @SDT, @CMND, @TenDangNhap);
SELECT id, MaNhanVien, TenNhanVien, ChucVu, NgaySinh, GioiTinh, DiaChi, Email, SDT, CMND, TenDangNhap FROM NHANVIEN WHERE (MaNhanVien = @MaNhanVien)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[NHANVIEN] SET [MaNhanVien] = @MaNhanVien, [TenNhanVien] = @TenNhanVien, [ChucVu] = @ChucVu, [NgaySinh] = @NgaySinh, [GioiTinh] = @GioiTinh, [DiaChi] = @DiaChi, [Email] = @Email, [SDT] = @SDT, [CMND] = @CMND, [TenDangNhap] = @TenDangNhap WHERE (([id] = @Original_id) AND ([MaNhanVien] = @Original_MaNhanVien) AND ([TenNhanVien] = @Original_TenNhanVien) AND ([ChucVu] = @Original_ChucVu) AND ([NgaySinh] = @Original_NgaySinh) AND ([GioiTinh] = @Original_GioiTinh) AND ([DiaChi] = @Original_DiaChi) AND ([Email] = @Original_Email) AND ([SDT] = @Original_SDT) AND ([CMND] = @Original_CMND) AND ([TenDangNhap] = @Original_TenDangNhap));
SELECT id, MaNhanVien, TenNhanVien, ChucVu, NgaySinh, GioiTinh, DiaChi, Email, SDT, CMND, TenDangNhap FROM NHANVIEN WHERE (MaNhanVien = @MaNhanVien)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::LibraryManager.Properties.Settings.Default.THUVIENMTAConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, MaNhanVien, TenNhanVien, ChucVu, NgaySinh, GioiTinh, DiaChi, Email, SD" +
                "T, CMND, TenDangNhap FROM dbo.NHANVIEN";
        ...
        public virtual int Fill(THUVIENMTADataSet.NHANVIENDataTable dataTable) {
        ...
        public virtual THUVIENMTADataSet.NHANVIENDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            THUVIENMTADataSet.NHANVIENDataTable dataTable = new THUVIENMTADataSet.NHANVIENDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(THUVIENMTADataSet.NHANVIENDataTable dataTable) {
        ...
        public virtual int Delete(int Original_id, string Original_MaNhanVien, string Original_TenNhanVien, string Original_ChucVu, System.DateTime Original_NgaySinh, string Original_GioiTinh, string Original_DiaChi, string Original_Email, string Original_SDT, string Original_CMND, string Original_TenDangNhap) {
        ...
        public virtual int Insert(string MaNhanVien, string TenNhanVien, string ChucVu, System.DateTime NgaySinh, string GioiTinh, string DiaChi, string Email, string SDT, string CMND, string TenDangNhap) {
            if ((MaNhanVien == null)) {
        ...
        public virtual int Update(
                    ...
                    string Original_CMND, 
                    string Original_TenDangNhap) {
            return this.Update(Original_MaNhanVien, TenNhanVien, ChucVu, NgaySinh, GioiTinh, DiaChi, Email, SDT, CMND, TenDangNhap, Original_id, Original_MaNhanVien, Original_TenNhanVien, Original_ChucVu, Original_NgaySinh, Original_GioiTinh, Original_DiaChi, Original_Email, Original_SDT, Original_CMND, Original_TenDangNhap);
        }
    }
